  ...
  <div class="app-container">
    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="image" label="履历" align="center">
        ...
        <el-table-column align="center" label="职位">
          <template slot-scope="scope">
            <span style="margin-right: 10px" v-if="scope.row.job == 1">首席执行官</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 2">首席运营官</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 3">首席技术官</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 4">首席财务官</span>
          </template>
        </el-table-column>
